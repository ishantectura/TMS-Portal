<%@ Page Title="" Language="C#" MasterPageFile="~/RoleBaseMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LRReadyForInvoice.aspx.cs" Inherits="LRReadyForInvoice" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  
    <h4>LR Ready For Invoice</h4>
    <br />
    ...
    <div class="clsParentGrid">
        <asp:UpdatePanel ID="updatepnl" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdAcceptedLR" runat="server" AutoGenerateColumns="false" PagerSettings-PageButtonCount="10"
                    AllowPaging="True" PageSize="20" PagerSettings-Position="Bottom" PagerSettings-Mode="NumericFirstLast"
                    EmptyDataText="No entries found." CssClass="clsHalfGrid" DataKeyNames="LRNo" OnPageIndexChanging="grdAcceptedLR_PageIndexChanging">
                    <Columns>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdAcceptedLRExcel" runat="server" AutoGenerateColumns="false" visible="false"
